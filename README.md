...
```
cd existing_repo
git remote add origin https://git.doit.wisc.edu/AAROVAS/IE_Graphing.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.doit.wisc.edu/AAROVAS/IE_Graphing/-/settings/integrations)
